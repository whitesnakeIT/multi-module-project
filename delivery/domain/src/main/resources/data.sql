...
INSERT INTO couriers (couriersCompany, firstName, lastName)
VALUES
    ('DHL', 'Jan', 'Kowalski'),
    ('DPD', 'Anna', 'Nowak'),
    ('UPS', 'Michał', 'Wójcik'),
...
INSERT INTO orders (sender_address, receiver_address, package_type, package_size, delivery_date)
VALUES
    ('ul. Kowalska 1, Warszawa', 'ul. Nowa 2, Kraków', 'DOCUMENT', 'SMALL', '2023-05-02'),
